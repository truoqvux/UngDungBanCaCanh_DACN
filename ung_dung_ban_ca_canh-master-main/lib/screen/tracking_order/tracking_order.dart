...
class OrderStatusScreenA extends StatefulWidget {
  OrderStatusScreenA({super.key});



  @override
  State<OrderStatusScreenA> createState() => _OrderStatusScreenState();
}

class _OrderStatusScreenState extends State<OrderStatusScreenA> {
  ...
  void initState() {
    super.initState();
    cartController.onFetchNewData(loginController.isAdmin.value, false );
  }
